...
<head>
    ...
    <!-- Icon web -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?= base_url() ?>assets/favicon/icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?= base_url() ?>assets/favicon/icon.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url() ?>assets/favicon/icon.png">
